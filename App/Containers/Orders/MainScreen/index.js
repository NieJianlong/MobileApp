...
class OrderScreen extends Component {
    ...
    renderFilter() {
        return (
            <TouchableOpacity onPress={this.toggleFilterSheet} style={styles.filterContainer}>
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.v2}>
                        ...
                        <Text style={styles.txt3}>
                            {item.lastMessage.author}: <Text style={{ color: Colors.grey60 }}>{item.lastMessage.content}</Text>
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.v3}>
                    {
                        item.isCompleted ?
                            ...
                            <Text style={styles.heading6Regular}>{moment(item.lastMessage.time).fromNow()}</Text>
                    }
                    {
                        item.unreadCount > 0 &&
