        ...
        return (
            <View style={[styles.container, style]}>
                <TouchableOpacity onPress={() => setUserRating(1)}>
                    <Image source={Images.starFilled} style={userRating >= 1 ? styles.filledBigStar : styles.emptyBigStar} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUserRating(2)}>
                    <Image source={Images.starFilled} style={userRating >= 2 ? styles.filledBigStar : styles.emptyBigStar} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUserRating(3)}>
                    <Image source={Images.starFilled} style={userRating >= 3 ? styles.filledBigStar : styles.emptyBigStar} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUserRating(4)}>
                    <Image source={Images.starFilled} style={userRating >= 4 ? styles.filledBigStar : styles.emptyBigStar} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => setUserRating(5)}>
                    <Image source={Images.starFilled} style={userRating >= 5 ? styles.filledBigStar : styles.emptyBigStar} />
                </TouchableOpacity>
            </View>
        )
    } else return (
