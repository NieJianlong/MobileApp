        ...
        <View style={styles.container}>
            <View>
                <View style={styles.row}>
                    ...
                    <View style={[styles.bar, { width: s(ratingDetail.fiveStar / maxRating * MAX_WIDTH) }]} />
                </View>

                <View style={styles.row}>
                    <Text style={styles.txt}>4</Text>
                    <View style={[styles.bar, { width: s(ratingDetail.fourStar / maxRating * MAX_WIDTH) }]} />
                </View>

                <View style={styles.row}>
                    <Text style={styles.txt}>3</Text>
                    <View style={[styles.bar, { width: s(ratingDetail.threeStar / maxRating * MAX_WIDTH) }]} />
                </View>

                <View style={styles.row}>
                    <Text style={styles.txt}>2</Text>
                    <View style={[styles.bar, { width: s(ratingDetail.twoStar / maxRating * MAX_WIDTH) }]} />
                </View>

                <View style={styles.row}>
                    <Text style={styles.txt}>1</Text>
                    <View style={[styles.bar, { width: s(ratingDetail.oneStar / maxRating * MAX_WIDTH) }]} />
                </View>
            </View>
            ...
            <View style={styles.ratingContainer}>
                ...
                <Text style={ApplicationStyles.screen.txtRegular}>{ratingCount} Reviews</Text>
            </View>
        </View>
    )
}
