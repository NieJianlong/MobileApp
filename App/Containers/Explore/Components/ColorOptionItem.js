    ...
    if (available) {
        return (
            <TouchableOpacity
                ...
                style={[styles.container, active && { borderColor: Colors.secondary00 }, style]}>

                <View style={styles.row}>
                    <ImageBackground
                        borderRadius={50}
                        style={styles.image}
                        source={{ uri: 'https://www.color-blindness.com/color-name-hue-tool/js/images/map-red-min.png' }}
                    />
        ...
        return (
            <View
                ...
                <TouchableOpacity style={[styles.row]}>
                    <Image resizeMode={'contain'} source={Images.mail} style={styles.icMail} />
                    <Text style={[ApplicationStyles.screen.heading5Bold, { color: Colors.secondary00 }]}>
                        Notify me
                    </Text>
                </TouchableOpacity>
            </View>
